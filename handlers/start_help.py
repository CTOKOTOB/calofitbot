...
async def handle_start(message: Message):
    await message.answer(
        "Привет! Я буду помогать тебе вести дневник питания. Просто напиши, сколько калорий съедено — я сохраню это. Если не знаешь точно, укажи блюдо или продукт, я уточню у нейросети и запишу."
    )
